...
#define ngx_atomic_cmp_set(lock, old, set)                                    \
     ((ngx_atomic_uint_t) InterlockedCompareExchange64((long *) lock, set, old)\
                          == old)
...
#define ngx_atomic_cmp_set(lock, old, set)                                    \
     (InterlockedCompareExchange64((void **) lock, (void *) set, (void *) old)\
      == (void *) old)

#endif


#define ngx_atomic_fetch_add(p, add) InterlockedExchangeAdd64((long *) p, add)
